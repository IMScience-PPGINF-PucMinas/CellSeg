...
def run_sicle_on_crop(
    ...
    Path costs follow RunSICLE: ``--conn-opt`` (fmax, fsum, custom) and ``--crit-opt`` (size, minsc, maxsc, spread, custom).
...
def main():
    ...
    parser.add_argument(
        "--sicle-conn-opt",
        default=None,
        choices=("fmax", "fsum", "custom"),
        help="Override --sicle-preset: RunSICLE --conn-opt (use with --sicle-crit-opt).",
    )
    parser.add_argument(
        "--sicle-crit-opt",
        default=None,
